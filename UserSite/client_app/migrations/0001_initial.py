    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='0', help_text='0: 注文済み, 1: 配達中, 2: 申請済み, 3: 支払い待ち, 4: 支払い完了', max_length=1, verbose_name='配達ステータス')),
                ...
                ('client', models.ForeignKey(on_delete=models.SET(client_app.models.get_sentinel_user), related_name='client', to=settings.AUTH_USER_MODEL, verbose_name='クライアント')),
                ('worker', models.ForeignKey(blank=True, null=True, on_delete=models.SET(client_app.models.get_sentinel_user), related_name='worker', to=settings.AUTH_USER_MODEL, verbose_name='配達員')),
            ],
        ),
        migrations.CreateModel(
            name='Request',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order', to='client_app.task', verbose_name='注文')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('task', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='transaction', to='client_app.task', verbose_name='関連するタスク')),
            ],
        ),
    ]
